        ...
        <h4 class="overflow-hidden transition-all duration-300 font-semibold text-[22px] leading-[26px] w-full">
          <span class="flex gap-2 items-center cursor-pointer justify-center" >
            ...
            <div class="flex flex-col">
              ...
              <p class="whitespace-wrap text-[18px] leading-4 text-[#64748B]">Hospital Management System</p>
            </div>
          </span>
        </h4>
      </div>
      <div class="bg-[#F0FBFF]  px-4 sm:px-0 h-full flex flex-col justify-center items-center">
        <h3 class="font-semibold text-[32px] text-blue-dark sm:mb-4">{{t('WELCOME')}}</h3>
        ...
        >
          <el-form ref="ruleFormRef" :model="form" :rules="rules" label-position="top" @keyup.enter="submit">
            <el-form-item :label="t('LOGIN')" prop="phone">
              <v-input v-model="form.phone" :placeholder="t('ENTER_YOU_LOGIN')" />
            </el-form-item>
...
.box-shadow {
  box-shadow: 0px 4px 16px 0px #2339551a;
}
