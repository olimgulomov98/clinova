...
const tabs = ref([
  {
    ...
    code: "TODAY",
    value: [
      dayjs().startOf("day").format("YYYY-MM-DDTHH:mm:ss[Z]"),
  ...
  },
  {
    ...
    code: "WEEK",
    value: [
      dayjs().startOf("week").format("YYYY-MM-DDTHH:mm:ss[Z]"),
      dayjs().endOf("week").format("YYYY-MM-DDTHH:mm:ss[Z]"),
    ],
  },
  {
    label: t("MONTH"),
    ...
    value: [
      ...
      dayjs().endOf("month").format("YYYY-MM-DDTHH:mm:ss[Z]"),
    ],
  },
  {
    label: t("ALL"),
